      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <p className="bio">
            ...
            learning p5.js and generative art. Each week, I explored new programming 
            concepts and created visual experiments.
          </p>
          <p className="bio">
            Click on any project below to see what I learned and view the live sketch.
          </p>
        </div>
      </section>
