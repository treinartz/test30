/*
  ...
  Edit each week with YOUR information.
  
  CODE SNIPPETS: Use backticks (`) for multi-line code.
  This preserves formatting exactly as you type it.
...
export const weeks = [
  {
    ...
    gifPath: "/src/assets/gifs/week0-environment.gif",
...
git push origin main`
...

  {
    ...
    gifPath: "/src/assets/gifs/week1-canvas.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function draw() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week2-variables.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function draw() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week3-functions.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function drawFlower(x, y, size) {
...

  {
    ...
    gifPath: "/src/assets/gifs/week4-conditionals.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function draw() {
  if (isDay) {
    ...
    background(25, 25, 112); // Dark blue
    fill(255);
    ellipse(350, 50, 60, 60); // Moon
  }
}
...
function mousePressed() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week5-loops.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function draw() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week6-nested.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function draw() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week7-strings.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function draw() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week8-arrays.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
function mousePressed() {
...

  {
    ...
    gifPath: "/src/assets/gifs/week9-objects.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
...
class Ball {
...

  {
    ...
    gifPath: "/src/assets/gifs/week10-json.gif",
    sketchUrl: "https://editor.p5js.org/your-username/sketches/xxxxx",
    learnings: [
